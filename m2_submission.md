...
<tr><td> <em>Generated: </em> 2/7/2022 12:07:45 AM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-010-S22/m2-php-hw/grade/sb59" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/42818731/152357741-5c1559e0-1234-4cd7-82bb-cd98d8a71ae3.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>sb59 2/3 - I am attempting to loop through the values in the<br>function&#39;s argument array and only output odd values<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>The function loops through each array and checks if the value modulus 2<br>is 1 or (x % 2 ==1 where x is the value in<br>the array iteration). If this is true, it means that when divided by<br>2 the remainder will be 1 or that it will be an odd<br>number. Only then will it output the number along with a newline. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/42818731/152357792-0cf07165-2aa7-4d16-b485-c9c6db10323c.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>sb59 2/3 - I attempting to sum all the values in the function&#39;s<br>argument array and then output them as two decimal point values<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>This loops through the entire array and sums up all the values. After<br>that, it rounds them using the number_format() function instead of the round() function<br>in order to preserve two decimal places no matter what. Round will only<br>preserve it if it doesn&#39;t end in a 0. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/42818731/152357862-49673c29-6aa5-4b66-a902-22f3c6234689.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>sb59 2/3 - I am attempting to loop through all the values of<br>the function&#39;s argument array and output all values as positive values<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>Loops through the array, if its a negative value, multiplies it by -1<br>before outputting it. If it&#39;s a positive value, outputs it directly. Prints a<br>newline separately. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://sb59-dev.herokuapp.com/M2/problem1.php">https://sb59-dev.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://sb59-dev.herokuapp.com/M2/problem2.php">https://sb59-dev.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://sb59-dev.herokuapp.com/M2/problem3.php">https://sb59-dev.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/SahilBamb/IT202-010/pull/7">https://github.com/SahilBamb/IT202-010/pull/7</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <h3 id="what-i-learned">What I Learned</h3><br><p>I better understood Heroku and its usefulness in hosting our<br>webpages as well as connecting it to our GitHub so that we can<br>automatically deploy. It&#39;s exciting thinking about how easy it would be to working<br>on a live project and just having to push your changes to GitHub<br>for Heroku to automatically deploy the changes. </p><br><h3 id="problems">Problems</h3><br><p>I had an issue with<br>using the PHP Server on my local machine to test out my PHP<br>code. I continually got an error that the file was not found when<br>it was very clearly there. I was able to test my code with<br>MAMP but I was not able to running my own PHP server in<br>terminal nor was I able to doing it through the PHP Server extension.<br>I hope to speak with the Professor about this in class today (2/3).<br><br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-010-S22/m2-php-hw/grade/sb59" target="_blank">Grading</a></td></tr></table>
